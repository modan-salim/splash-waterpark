...
<section class="top">
<div class="first">
    <img src="assets/images/sunami.jpg" alt="">
    </div>
    <div class="fi-1">
        <h1>
          TSUNAMI BAY
    ...
    <div class="fi-2">
        <p>The largest wave pool in the region, which produces parallel and crossing 1 metre<br> waves in 8 different formations. For all ages and the whole family to enjoy.</p>
    </div>
    <div class="fi-3">
        <h2>👉Requirements👈</h2>
    ...
    <div class="fi-5">
      ...
      - lifejackets or personal flotation devices to be used on this slide<br><br>
      ...
      - <br>
      -Children under 6 years old must be accompanied by responsible adult<br><br>.
      Appropriate swimwear must be worn at all times.<br><br>
      No personal floatation devices to be used in The Wave Pool.<br><br>
      Toddlers entering the water must wear water proof diapers only.<br><br>
    </div>
  </section>
