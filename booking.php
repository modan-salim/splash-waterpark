...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="assets/css/booking1.css">

  <script>
    function validate() {
      alert("are you sure you want to book tickets!");
...
<body>
  ...
  <div class="container-sm my-5 mt-5 mb-5 px-5 py-5 text-white bg-info rounded">
  ...
  <div class="input-group mb-3">
        ...
        <input type="text" class="form-control"  aria-describedby="basic-" name="fullname" required>
      ...
      <div class="input-group mb-3">
        ...
        <select class="form-select" aria-label="Default select example" name="tickets" id="optionlist1">
          <option value="">select</option>
          <option value="1000r">1(1000r)</option>
          <option value="2000r">2(2000r)</option>
          <option value="3000r">3(3000r)</option>
          <option value="4000r">4(4000r)</option>
          <option value="5000r">5(5000r)</option>
          <option value="6000r">6(6000r)</option>
          <option value="7000r">7(7000r)</option>
          <option value="8000r">8(8000r)</option>
          <option value="9000r">9(9000r)</option>
          <option value="10000r">10(10000r)</option>
        </select>
      </div>
