...
<div class="first">
    <img src="assets/images/ride.jpg" alt="">
    </div>
   
   <div class="fi-1"> 
    <h1>
        INSANO, AQUA DRAG, <br>TORNADO, TWISTER, BULLET BOWL
    </h1>
</div>
   ...
   <div class="fi-2">
        <p>Body slide – no tubes needed to ride this slide Stay safe, have fun & enjoy</p>
    </div>
    <div class="fi-3">
        <h2>👉Requirements👈</h2>
