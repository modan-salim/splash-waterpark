...
<section>
<div class="first">
    <img src="assets/images/bubba.jpg" alt="">
    </div>
    <div class="fi-1">
        <h1>
            Manta & Bubba tube
    ...
    <div class="fi-2">
        <p>Fun for the whole family! Enjoy sharing the ride on a giant inner tube that will<br> take you by surprise ending in a refreshing landing.</p>
    </div>
    <div class="fi-3">
        <h2>👉Requirements👈</h2>
    ...
    <div class="fi-5">
      ...
      - Maximum ride weight is 454 Kgs.<br><br>
      - 3 to 6 guest family ride.<br><br>
      - Appropriate swimwear must be worn at all times.<br><br>
      Swimwear with exposed zippers, buckles, rivets, or any metal ornamentationaa<br> are not permitted on this attraction.
    </div>
    </section>
    <div class="footer">
