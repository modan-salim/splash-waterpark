...
        </div>
    <div class="first">
    <img src="assets/images/bigthunder2.jpg" alt="">
    </div>
   
   <div class="fi-1">
    <h1>
        BIG THUNDER, SPLASH <br>DOWN, MASTER BLASTER
    </h1>
</div>
    ...
    <div class="fi-2">
        <p>Raft slide – Raft is needed to ride this slide</p>
    </div>
    <div class="fi-3">
        <h2>👉Requirements👈</h2>
    ...
    <div class="fi-5">
      - Minimum rider height 107 cm.<br><br>
      - Minimum 1 rides maximum 2 rides allowed per raft.<br><br>
      - Maximum operational load 182 Kgs.<br><br>
      - Maximum load per person 136 Kgs.<br><br>
      - Children under 107 cm tall are not permitted on this ride.<br><br>
      - Always wear appropriate swimwear, Nylon and Lycra materials only.<br><br>
      - Must be completely seated in the tube and back against the tube.<br><br>
      - Hold handles with both hands.<br><br>
      - Guest are not allowed to kneel or to sit on top of the raft.<br><br>
      - Stay in this position till the end of the slide.<br><br>
      - Only one raft to enter the flume at a time.<br><br>
      - Eyeglasses must be securely affixed to riders with head straps.<br><br>
      - Swim wear with exposed zippers, buckles, rivets or metal ornamentations are not permitted.<br><br>
      - Riders must wait for the lifeguards start signal before starting the ride.<br><br>
      - Do not run, dive, stand, kneel, rotate or stop in the slide.<br><br>
      - At the end of the slide, exit the slide quickly.<br><br>
    </div>
