...
<section>
<div class="first">
    <img src="assets/images/whiz2.jpg" alt="">
    </div>
    <div class="fi-1">
        <h1>
          Whizzard
    ...
    <div class="fi-2">
        <p>This adrenaline-charged ride consists of six adjacent mat slides where you can<br> race together with your friends but be warned- it is truly wet and wild!</p>
    </div>
    <div class="fi-3">
        <h2>👉Requirements👈</h2>
    ...
    <div class="fi-5">
      - Minimum rider height is 107 cm.<br><br>
      - Maximum rider weight is 136 Kgs.<br><br>
      - Only one rider to enter each lane at one time. Single rider only.<br><br>
      - Appropriate swimwear must be worn at all times.<br><br>
      - Swimwear with exposed zippers, buckles, rivets, or any metal ornamentation are not permitted on this attraction.<br><br>
      Riders may experience loss of orientation due to darkness in the slide.<br><br>
    </div>
    </section>
    <div class="footer">
