...
<div class="first">
    <img src="assets/images/kids3.jpeg" alt="">
    </div>
   ...
   <div class="fi-2">
        <p>OPEN FLUME (BODY SLIDE)<br>
          The twisting and turning ride culminates with a relaxed pass through and drops<<br> down into the splash pool.</p>
    </div>
    <div class="fi-3">
        <h2>👉Requirements👈</h2>
    ...
    <div class="fi-5">
      - Minimum rider height 122 cms.<br><br>
      - Maximum operational load 1 person, 136 Kgs<br><br>
      -  Children under 122 cms tall are not permitted on this ride<br><br>
      ...
      - No lifejackets or personal flotation devices to be used on this slide.<br><br>
      ...
      - At the end of the slide, obey all instructions by Lifeguards and exit the
      slide quickly.
