...
<section>
<div class="first">
    <img src="assets/images/boom.jpg" alt="">
    </div>
    <div class="fi-1">
        <h1>
          BOOMBASTIC
    ...
    <div class="fi-2">
        <p> Raft slide – raft is needed to ride this slide Stay safe, have fun & enjoy</p>
    </div>
    <div class="fi-3">
        <h2>👉Requirements👈</h2>
    ...
    <div class="fi-5">
      ...
      - Minimum 2 rides maximum 4 rides allowed per raft.<br><br>
      - Maximum load per person 136 Kgs.<br><br>
      - Children under 122 cms tall are not permied on this ride<br><br>
